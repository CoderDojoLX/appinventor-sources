 ...
 * Adapted from the excellent pt_BR translation by mail@eduardovalle.com (Eduardo Valle)
 */
'use strict';
...
Blockly.Msg.pt_pt.switch_language_to_portuguese_pt = {
  ...
  init: function() {
    ...
    Blockly.Msg.LANG_LISTS_TO_CSV_ROW_TOOLTIP = 'Interpreta a lista como a linha de uma tabela e retorna um texto CSV (valores separados por vírgula) representando a linha. Cada item na linha é considerado um campo, e é citado com aspas duplas (") no resultado do texto CSV. Os elementos são separados por vírgulas. O texto da linha retornado não terá um separador de linha ao final.';
